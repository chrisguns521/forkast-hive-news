...
const TweetCard: React.FC<TweetCardProps> = ({ tweet, className }) => {
  return (
    <article className={`news-card bg-white rounded-lg shadow-md overflow-hidden ${className}`}>
      <div className="p-4">
        <div className="flex items-center">
          ...
          <div>
            <div className="flex items-center">
              <span className="font-semibold mr-1">{tweet.author.name}</span>
            ...
            <div className="text-sm text-muted-foreground">@{tweet.author.handle}</div>
          </div>
        ...
        <p className="mt-3 text-sm whitespace-pre-line">{tweet.content}</p>
